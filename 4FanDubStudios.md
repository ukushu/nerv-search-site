...
```
*   Коли ви отримуєте доступ модера - прийде повідомлення від самого бота. Як ви отримаєте повідомлення ви можете видалити цей пост з вашого пабліку. Він стає непотрібним. А можете залишити його як рекламний, нам буде приємно (  ^)3(^_^)
