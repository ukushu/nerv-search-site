...
* Канал що містить в собі всю ФРАНШИЗУ { не плутати з сезоном } - це дозволить отримувати оновлення по франшизі котру глядач вже почав дивитися. Навіть, якщо оновлення буде виходити через рік чи два.
