...
* TV: [DeapLink](https://core.telegram.org/api/links) на ваш бот з автоматичним відкриттям ВСІХ серій сезону/тайтлу оформлення близьке до еталону. (Внизу доп.інфа про діплінки)
